...
func TestHostWiring(t *testing.T) {
	...
	if want := "musicbrainz://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("musicbrainz", "about")
	if err != nil || got.String() != "musicbrainz://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want musicbrainz://page/about", got.String(), err)
	}
}

...
```
musicbrainz <command> [arguments] [flags]
```

Run `musicbrainz <command> --help` for the full flag list on any command. This
...
per operation you declare in `musicbrainz/domain.go`.
